...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-CH9WCLBMWH"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-CH9WCLBMWH');
</script>
...
})(window,document,'script','dataLayer','GTM-M8H9F48K');</script>
<!-- End Google Tag Manager -->
    ...
    <script src="https://www.google.com/recaptcha/api.js" async defer> </script>
        ...
        fbq('init', '851386039746079');
        fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=851386039746079&ev=PageView&noscript=1"
        /></noscript>
        <!-- End Meta Pixel Code -->

        <!-- canonical code-->

        <link rel="canonical" href="https://tradersera.com/" />
<!-- font-awesome -->
        <script src="https://kit.fontawesome.com/e6fa0b1cad.js" crossorigin="anonymous"></script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M8H9F48K"
                    ...
                    <div class="col col-lg-8 col-md-12 d-none d-lg-block">
                        <div class="contact-details ">
                            <ul class="contact" style="display: flex;position: absolute;margin-top: 4px;">
                                <li><img class="mx-2" src="assets/images/icon/mail icon png.webp" alt="">
                                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=support@tradersera.com"
                                        target="_blank">support@tradersera.com</a>
                                </li>

                                <li><img class="mx-2" src="assets/images/icon/call icon png.webp" alt="">
                ...
                <div class="right-area position-relative  ms-0 d-end gap-1 gap-xl-4 d-none d-lg-flex">
                    ...
                    <div class="single-item" style="margin-right: 10px; ">
                        <a href="https://private.tradersera.cfd/signup"
                            class="rotate_eff flex-nowrap py-1 px-2 px-xl-3 d-end gap-1 fw-bold nw-button"  style="background-color:#d0a460; color: black;" target="_blank">
                            Open an Account </a>
                    </div>
                    <div class="single-item">
                        <a href="forex-bonus.php"
                            class="rotate_eff flex-nowrap py-1 px-2 px-xl-3 d-end gap-1 fw-bold nw-button"style="background-color: #d0a460; color: black;" target="_blank">
                            50% Bonus</a>
                    </div>
                </div>
            ...
            <nav class="navbar rounded-3 navbar-expand-lg w-100 justify-content-between ">
                ...
                <div class="nav_alt">
                    <div class="right-area position-relative ms-0 d-center gap-1 gap-xl-4 d-lg-none">
                        <div class="single-item">
                            <a href="https://private.tradersera.cfd/signin" target="_blank"
                    ...
                    <ul class="navbar-nav gap-2 gap-lg-3 gap-xxl-8  align-self-center mx-auto mt-4 mt-lg-0">
                        ...
                        <li class="dropdown show-dropdown">
                            ...
                            <li class="dropdown show-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    Center</a></li>
                                    <li><a class="dropdown-item" href="Externally-Managed-Account.php">Externally Managed Account</a></li>
                                    <li><a class="dropdown-item" href="pwa-web-app-tradersera.php">Web App</a></li>
                        ...
                        <li class="dropdown show-dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item " href="learn-crypto.php">Learn Crypto</a></li>
                                <li><a class="dropdown-item " href="learn-forex.php">Learn Forex</a></li>
                        ...
                        <li class="dropdown show-dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="Fund-manager.php">Fund Manager</a></li>
                            </ul>
                        </li>
                        <li class="dropdown show-dropdown">
                            <button type="button" aria-label="Navbar Dropdown Button"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="our-technology.php">Our Technology</a></li>
