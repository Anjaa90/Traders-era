                ...
                <div class="platform row" style="padding-bottom:50px;">
                    <div class="col-md-4 provide-world__card text-center nb3-bg py-5 px-4 px-lg-5">
                        <span class="provide-card__icon d-center nb4-bg p-4 rounded-circle mx-auto">
                            <img src="assets/images/icon/number-1.png" alt="null" class="lazyload">
                        </span>
                        ...
                        <div class="d-inline-flex flex-wrap gap-4 gap-lg-10 align-items-center mt-2 mt-lg-1">
                            <a href=" https://download.mql5.com/cdn/mobile/mt5/android?server=BlackridgeTrading-Real"
                                target="_blank"
                                class="cmn-btn alt-xxl-bg fs-five nb4-xxl-bg gap-2 gap-lg-3 align-items-center py-lg-1 px-lg-2"
                                style="transform: scaleX(1); background-color: #9ad953; color: #000000; margin-top: 20px; border-radius: 5px;">Click Me</a>
                        </div>
                    </div>
                    <style>
                        .border-button {
                    ...
                    <div class="col-md-4 provide-world__card text-center nb3-bg py-5 px-4 px-lg-5">
                        <span class="provide-card__icon d-center nb4-bg p-4 rounded-circle mx-auto">
                            <img src="assets/images/icon/two.png" alt="null" class="lazyload">
                        </span>
                        ...
                        <div class="d-inline-flex flex-wrap gap-4 gap-lg-10 align-items-center mt-2 mt-lg-1">
                            <a href="https://download.mql5.com/cdn/mobile/mt5/ios?server=BlackridgeTrading-Real"
                                target="_blank"
                                class="cmn-btn alt-xxl-bg fs-five nb4-xxl-bg gap-2 gap-lg-3 align-items-center py-lg-1 px-lg-2"
                                style="transform: scaleX(1); background-color: #9ad953; color: #000000; margin-top: 20px; border-radius: 5px;">Click Me
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 provide-world__card text-center nb3-bg py-5 px-4 px-lg-5">
                        <span class="provide-card__icon d-center nb4-bg p-4 rounded-circle mx-auto">
                            <img src="assets/images/icon/number-3.png" alt="null" class="lazyload">
                        </span>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="trade_on__thumbs d-flex justify-content-end">
                    <img src="assets/images/financial markets trading hours.png"
                        alt="Trade Forex CFDs on TradersEra Paltform" class="lazyload">
                </div>
            </div>
        </div>
    </div>
