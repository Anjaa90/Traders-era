...
<head>
    ...
    <meta name="keywords" content="Online Forex Trading, MT5, Meta Trader 5, UTIP Trading Platform, Become a Partner, forex ib program, Best Forex Broker, Forex Introducing Brokers, 
                ...
                <div class="row justify-content-md-center">
                    <div class="col-lg-12">
                        <div class="banner-text text-center text-white">
                            <img src="images/icon/logo.png" alt="logo" class="img-logomain" class="lazyload">
                            <br>
                            <br>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="iq-countdown">
                            ...
                            <br>
                            <h5>Maximize Investments with Our All-in-One Online Trading Platform for Binary Options, AI
                                Assistance, and Forex Trading
                            </h5>
                            <br>
                            <a class="button iq-mt-50" href="https://private.tradersera.cfd/signup" target="_blank">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="fancy-box">
                        ...
                        <p>
                        <h5> Easily forecast asset movements within set <br>time frames, streamlining trading for the
                            Burmese community.
                        </h5>
                        </p>
                    </div>
    ...
    <section id="benefit" class="iq-Tranding-platform light-bg ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 iq-mt-30">
                    <div class="heading-title">
                        <a class="button iq-mt-50 iq-mb-50" href="https://private.tradersera.cfd/signup"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 d-flex justify-content-center">
                    <a class="button iq-mt-70" href="https://private.tradersera.cfd/signup" target="_blank"><svg
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <g data-name="Circle Right">
                                <path
                                    d="m17.706 11.292-3-3a1 1 0 0 0-1.414 1.414L14.586 11H7a1 1 0 0 0 0 2h7.586l-1.293 1.293a1 1 0 1 0 1.414 1.414l3-3a1 1 0 0 0-.001-1.415z"
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 iq-r-mt-40 ">
                        <div class="iq-small-icon">
                            <img src="images/icon/Register.png" alt="icon" class="img-fluid" class="lazyload"><br>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 iq-r-mt-40 ">
                        <div class="iq-small-icon">
                            <img src="images/icon/Verify.png" alt="icon" class="img-fluid" class="lazyload"><br>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 iq-r-mt-40 ">
                        <div class="iq-small-icon active">
                            <img src="images/icon/Fund.png" alt="icon" class="img-fluid" class="lazyload"><br>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 iq-r-mt-40 ">
                        <div class="iq-small-icon active">
                            <img src="images/icon/Trade.png" alt="icon" class="img-fluid" class="lazyload">
        ...
        <div class="container">
            <div class="row flex-row-reverse ">
                <div class="col-lg-6 align-self-center">
                    <img src="images/landing 2.png" class="img-fluid" alt="" class="lazyload">
                </div>
                <div class="col-lg-6 align-self-center mt-5 mt-lg-0">
                    <div class="heading-title left">
