            ...
            <div class="col-12 breadcrumb-area ">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item ms-2 ps-7 active" aria-current="page"><span>Binary Trading</span>
                        </li>
                    </ol>
                </nav>
            </div>
                                ...
                                <div class="company-story__part d-flex align-items-sm-center flex-column flex-sm-row">
                                    <div class="col-lg-1 d-flex">
                                        <img src="assets/images/icon/collaboration.png" alt="referral"
                                            class="referred_image" class="lazyload">
                                    </div>
        ...
        <div class="row gy-10 gy-xxl-0 justify-content-center justify-content-xxl-between align-items-center">
            ...
            <div class="col-10 col-sm-8 col-md-7 col-lg-6 order-2 order-lg-0 mt-20">
                <div class="trade_on__thumbs d-flex justify-content-end">
                    <img src="assets/images/binary options.png" alt="Web Based Tradersera Platform" class="lazyload">
                </div>
            </div>
        </div>
</section>
...
<section class="provide-world pt-120 pb-120  position-relative z-0"
    style="padding-bottom:25px; background-color: #000000;">
    <div class="container">
        <div class="row gy-6 gy-xxl-0">
            ...
            <div class="col-md-3 col-xxl-3">
                <div class="provide-world__card secondary nb3-bg text-center cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    <span class="provide-card__icon d-center nb4-bg p-4 rounded-circle mx-auto">
                        <img src="assets/images/icon/verify (1).png" alt="stock-market" class="lazyload">
                    </span>
            ...
            <div class="col-md-3 col-xxl-3">
                <div class="provide-world__card secondary nb3-bg text-center cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    <span class="provide-card__icon d-center nb4-bg p-4 rounded-circle mx-auto">
                        <img src="assets/images/icon/sharing.png" alt="stock-market" class="lazyload">
                    </span>
