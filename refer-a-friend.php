        ...
        <div class="row gy-10 gy-xxl-0 justify-content-center justify-content-xxl-between align-items-center">
            <div class="col-lg-6 col-xxl-5">
                <div class="trade_on__content">
                    ...
                    <p class="fs-six mx-ch">At TradersEra, We're thrilled to give you the unique chance to recommend
                        friends and advance your trading career
                        together because of this! <br><br> Being a client of TradersEra is always beneficial, and this
                        time around,
                        we're giving you back for referring friends. You will each receive 25% for each person you
                        recommend
                        who successfully creates a trading account with TradersEra!
                    </p>
                    <br>
                    <br>
                    <div>
        ...
        <div class="row gy-18 justify-content-between">
            ...
            <div class="col-12 col-lg-5 col-xl-5">
                <div class="submissions-area d-flex flex-column gap-8 gap-lg-10">
                    <div class="submissions">
                        <img class="contact-img" src="assets/images/reffer a friend form.png"
            ...
            <div class="col-12 col-lg-7 col-xl-6 nb3-bg">
                <form action="refer-a-friend-form.php" method="POST" class="contact__form alt_form px-4 px-lg-8">
                    ...
                    <div class="d-flex flex-column gap-4"> <!-- Ensure vertical alignment -->
                        <div class="single-input">
                            <input type="text" class="fs-six-up" name="friend_name" placeholder="Your Friend's Name *"
                                required>
                        </div>
                        <div class="single-input">
                            <input type="email" class="fs-six-up" name="friend_email"
                                placeholder="Your Friend's Email ID *" required>
                        </div>
                        <div class="single-input">
                            <input type="text" class="fs-six-up" name="friend_contact"
                                placeholder="Your Friend's Contact Number *" required>
                        </div>
                        <div class="single-input">
                            <select id="friend-country-select" name="friend_country" class="fs-six-up" required>
                                <option value="" disabled selected>Your Friend's Country *</option>
                    ...
                    <div class="d-flex flex-column gap-4"> <!-- Ensure vertical alignment -->
                        <div class="single-input">
                            <input type="text" class="fs-six-up" name="your_name" placeholder="Your Name">
                        </div>
                        <div class="single-input">
                            <input type="email" class="fs-six-up" name="your_email"
                                placeholder="Your Registered Email-ID">
                        </div>
                        <div class="single-input">
                            <input type="text" class="fs-six-up" name="account_no"
                                placeholder="Your TradersEra Account No.">
                        </div>
                    </div>
                    <div class="g-recaptcha" data-sitekey="6LfpCBMqAAAAANY7agf35xO_uqYdcGWOn9xeDwy3"></div>
                    <button type="submit" class="cmn-btn py-3 px-5 px-lg-6 d-flex ms-1 mt-8 mb-4" name="submit"
...
<style>
    .single-input select:required option:first-child {
        color: red;
    }
    .single-input input.required::placeholder {
