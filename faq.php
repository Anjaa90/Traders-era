...
<section class="faq pb-120 pt-120 position-relative z-0">
    <div class="animation position-absolute top-0 left-0 w-100 h-100 z-n1">
        <img src="assets/images/button.png" alt="vector"
            class="position-absolute pt-6 pt-xl-15 previewShapeRevX d-none d-xl-flex" class="lazyload">
        ...
        <img src="assets/images/vector20.png" alt="vector"
            class="position-absolute bottom-0 start-0 pb-11 ps-7 d-none d-xxxl-flex" class="lazyload">
    </div>
    <div class="container">
                ...
                <div class="faq__part">
                    <div class="accordion-section d-grid gap-6">
                        <div class="accordion-single  cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>Yes, TradersEra is committed to industry standards offering latest technology,
                                        market analytics and forecasts, security of access with advanced servers and
                                        authentications, fund safety with segregated bank accounts, KYC & AML
                                        Compliance, Local Payment Methods combined with 24/5 Customer Team for your
                                        assistance. Making it a reliable Trading Partner for you.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                        ...
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>Yes, TradersEra offers 24/5 customer support via live chat, email, and phone. Our
                        ...
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>Yes, TradersEra provides a range of educational resources, including tutorials,
                                        webinars, and articles designed to help traders improve their skills and
                                        knowledge.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>TradersEra operates under the regulations of [insert relevant regulatory body],
                                        ensuring compliance with industry standards for trading platforms.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>TradersEra uses advanced security protocols, including SSL encryption and secure
                                        server technology, to protect your personal and financial information.
                                    </p>
                                </div>
                            </div>
                        </div>
