                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="iq-countdown">
                            ...
                            <br>
                            <a class="button iq-mt-50" href="https://private.tradersera.cfd/signup" target="_blank"> <svg
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 align-self-center">
                    <img style="height:300px; width:500px;" src="images/landing 1.png" class="img-fluid" alt="" class="lazyload">
                </div>
            ...
            <div class="row">
                    ...
                    <div class="iq-blog-box">
                        <div class="iq-blog-image clearfix">
                            <img class="img-fluid center-block"
                                src="images/tradersera landing page trading options png-compressed.jpg" alt="#" class="lazyload">
                        </div>
                ...
                <div class="item col-lg-4 col-md-4 col-sm-12">
                    <div class="iq-blog-box">
                        <div class="iq-blog-image clearfix">
                            <img class="img-fluid center-block"
                                src="images/tradersera landing page user friendly interface png-compressed.jpg" alt="#" class="lazyload">
                        </div>
                        <div class="iq-blog-detail">
                            <div class="blog-title"> <a href="#">
    ...
    <section id="account" class="iq-tranding-Platform overview-block-pb trending-2 iq-ptb-100">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid"
                        src="images/traderaera landingpage Our Trading Accounts for Your Perfect Fit.png" alt="#" class="lazyload">
                </div>
